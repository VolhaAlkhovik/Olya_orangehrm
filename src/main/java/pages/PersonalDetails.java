...
public class PersonalDetails extends BasePage {
  ...
  private By otherId =
      By.xpath(
          "//label[normalize-space()='Other Id']/parent::div/following-sibling::div//input[contains(@class,'oxd-input')]");
  private By driverLicenseNumber =
      By.xpath(
          "//label[contains(normalize-space(.),'License Number')]/parent::div/following-sibling::div//input[contains(@class,'oxd-input')]");
  private By licenseExpirydate =
      By.xpath(
          "//label[contains(normalize-space(.),'License Expiry')]/parent::div/following-sibling::div//input[contains(@class,'oxd-input')]");
  private By nationality =
      By.xpath(
          "//label[contains(normalize-space(.),'Nationality')]/parent::div/following-sibling::div//div[contains(@class,'oxd-select-wrapper')]");
  private By nationalityBelgian =
      By.xpath("//div[@class='oxd-select-option']//span[text()='Belgian']");
  private By maritalStatus =
      By.xpath(
          "//label[contains(normalize-space(.),'Marital')]/parent::div/following-sibling::div//div[contains(@class,'oxd-select-wrapper')]");
  private By maritalStatusSingle =
      By.xpath("//div[@class='oxd-select-option']//span[text()='Single']");
  private By dateOfBirth =
      By.xpath(
          "//label[contains(normalize-space(.),'Date of')]/parent::div/following-sibling::div//input[contains(@class,'oxd-input')]");
  private By genderMaleRadio =
      By.xpath("//label[normalize-space(.)='Male']//span[contains(@class,'oxd-radio-input')]");
