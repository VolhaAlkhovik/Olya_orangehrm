...
public class SaveLocation extends BasePage {
    ...
    private By nameLocation = By.xpath("//label[normalize-space(.)='Name']/parent::div/following-sibling::div/input");
    private By city = By.xpath("//label[normalize-space(.)='City']/parent::div/following-sibling::div/input");
    private By zip = By.xpath("//label[normalize-space(.)='Zip/Postal Code']/parent::div/following-sibling::div/input");
    private By phone = By.xpath("//label[normalize-space(.)='Phone']/parent::div/following-sibling::div/input");
