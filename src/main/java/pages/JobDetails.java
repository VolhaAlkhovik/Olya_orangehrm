...
public class JobDetails extends BasePage{
    ...
    private By jobTitle = By.xpath("//label[normalize-space(text())='Job Title']/ancestor::div[contains(@class,'oxd-input-group')]//div[contains(@class,'oxd-select-text-input')]");
